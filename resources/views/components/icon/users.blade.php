...
@if($solid)
    <svg {{ $attributes->merge(['class' => $classes.' h-'.$size.' w-'.$size]) }} aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user-group" class="svg-inline--fa fa-user-group" role="img"
