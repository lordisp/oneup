...
@else
    <svg {{ $attributes->merge(['class' => $classes.' h-'.$size.' w-'.$size]) }} aria-hidden="true" focusable="false" data-prefix="fas" data-icon="users" class="svg-inline--fa fa-users" role="img"
