...
class ScimAddMemberJob extends WebhookJob implements ShouldQueue
{
    ...
    {
        $this->updateState('Acknowledged', $this->scope, 'processing user-import');
        $members = $this->getMembers();
        foreach ($members as $member) {
            ImportUserJob::dispatch($member, $this->graphProvider)->onQueue('webhook');
        }
